...
export const Emergency = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-6">
      ...
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-500 via-purple-600 to-pink-600 backdrop-blur-xl rounded-3xl border border-white/50 shadow-2xl p-8 mb-6">
          <h1 className="text-4xl font-bold text-white mb-2">Emergency Access Management System</h1>
        ...
        <div>
          ...
          {activeSessions.length === 0 ? (
            <div className="bg-white/40 backdrop-blur-xl rounded-3xl border border-white/50 shadow-2xl p-8 text-center text-gray-700">
              <p className="text-4xl mb-2">🔒</p>
              <p className="font-medium">No active emergency sessions</p>
            </div>
          ) : (
