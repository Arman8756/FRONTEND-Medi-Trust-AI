...
export const KeyManagerCard: React.FC<KeyManagerCardProps> = ({ currentKey, onRotate }) => {
  ...
  return (
    <div className="bg-white/40 backdrop-blur-xl rounded-3xl border border-white/50 shadow-2xl p-6">
      <h3 className="text-2xl font-bold text-gray-800 mb-6">Encryption Key Manager</h3>
      <div className="space-y-4">
        <div className="bg-gradient-to-r from-blue-400/20 to-purple-400/20 backdrop-blur-sm p-4 rounded-2xl border border-white/60">
