...
export const AccessTable: React.FC<AccessTableProps> = ({ permissions, onRevoke, onRefresh }) => {
  ...
  return (
    <div className="bg-white/40 backdrop-blur-xl rounded-3xl border border-white/50 shadow-2xl p-6">
      <h3 className="text-2xl font-bold text-gray-800 mb-6">Access Permissions ({permissions.length})</h3>
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-white/60 backdrop-blur-sm border border-white/60 rounded-2xl focus:outline-none focus:ring-2 focus:ring-purple-400 shadow-inner"
            />
          </div>
          <button
            onClick={onRefresh}
